...
import com.giordanogiammaria.microapp30.Subsystem.ComponentNotFoundException;
...
public class MicroAppGenerator {
    ...
    public MicroAppGenerator(String filePath) throws FileNotFoundException, MissingComponentTypeException {
    ...
    public Fragment nextCompFragment() throws NoNextComponentException, MissingDataException, DataMismatchException, ComponentNotFoundException {
        if (currentIndex < components.size() - 1) {
            ...
            for (String destId : currentComp.getOutputReceivers()) {
                Component destComp = findComponent(destId);
    ...
    private Component findComponent(String id) throws ComponentNotFoundException {
